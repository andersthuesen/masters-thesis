...
% MotionBERT
% "Can 3d pose be learned from 2d projections alone?" (Trains discriminator)
% ElePose (Normalizing flows on 2D poses guides 3D lifting network that upon projection have high probability w.r.t. the normalizing flows model)
% MAS 
...
%This thesis explores three innovative models—Human Motion Diffusion, InterGen, and PhysDiff—that collectively enhance the state of the art in human motion generation.



% History of motion generation
